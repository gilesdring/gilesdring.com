...
<html>{{ comp.embed.Strava({ page }) }}</html>
...
<html>{{ comp.embed.Strava({ link: 'https://www.strava.com/activities/3852088132/embed/6287ae7ae2fca7dd63e91326d17bba886da38ea0' }) }}</html>

The Beastie Boys Ill Communication helped...

<html>{{ comp.embed.Spotify({ page }) }}</html>
